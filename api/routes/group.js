...
router.put(
  "/:groupId/update/avatar",
  groupController.updateGroupAvatarController
);
...
router.get(
  "/:groupId/pending-posts-count",
  groupController.getPendingPostsCount
);
router.get(
  "/:groupId/pending-requests-count",

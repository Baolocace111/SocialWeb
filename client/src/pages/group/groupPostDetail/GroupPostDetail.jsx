...
const GroupPostDetail = () => {
    ...
    const { data: post, isLoading: isPostLoading, error: postError } = useQuery(['group-post', postId], () =>
    ...
    if (postError) return <div className="error-message">Lỗi: {postError.message}</div>;

        ...
        <div className="user">
          ...
          <MoreHorizIcon
            style={{
              ...
              borderRadius: "50%", transition: "background-color 0.3s",
          ...
          >
            <List>
              <ListItemButton onClick={handleDialogOpen}>
                <ListItemIcon style={{ fontSize: "18px", marginRight: "-25px" }}>
            ...
            <Dialog open={openEdit} onClose={handleDialogClose}>
              <DialogTitle sx={{ m: 0, p: 2, display: 'flex', mt: '-5px', mb: '-10px' }}>
                <Typography variant="title1" style={{ flexGrow: 1, textAlign: "center" }}>
                  <EditIcon sx={{ marginRight: '8px', fontSize: "20px" }} />
                  <span style={{ fontSize: "22px", fontWeight: "700" }}>Chỉnh sửa bài viết</span>
                </Typography>
              </DialogTitle>
              <Divider />
              <DialogContent>
                <div style={{
                  ...
                  alignItems: "center", margin: "-10px 0 15px -10px"
                }}>
                  <div
                    style={{
                      paddingRight: "15px",
                ...
                {selectedImage && (
                  <div style={{ display: "flex", justifyContent: "center" }}>
                    <div style={{ position: 'relative', display: 'inline-flex' }}>
                      <img src={selectedImage} alt="" style={{ maxWidth: "400px" }} />
                      <button
                        style={{
                          position: 'absolute',
                          top: '5px',
